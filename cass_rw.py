# -*- coding: utf-8 -*-
"""
Created on Thu Dec 17 23:31:20 2020
...
class CassandraReadWriteDb:
    ...
    def write_file_table(self, credit_logs):
        with open(credit_logs) as csv_file:
            csv_reader = csv.DistReader(csv_file, delimiter=',')
...
if __name__ == '__main__':
    ...
    cwd = CassandraReadWriteDb(ip_addrs=[''], keyspace= 'emp')
